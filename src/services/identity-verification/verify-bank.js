 ...
 *
 */
var VerifyBankAccount = /** @class */ (function (_super) {
    __extends(VerifyBankAccount, _super);
    function VerifyBankAccount(publicKey, secretKey) {
     ...
     */
    VerifyBankAccount.prototype.verifyBankAccount = function (data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.post("/core/accounts/resolve", data)];
                    case 1:
                        response = _a.sent();
