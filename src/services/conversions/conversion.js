...
var Conversion = /** @class */ (function (_super) {
    ...
    function Conversion(publicKey, secretKey) {
        return _super.call(this, publicKey, secretKey) || this;
    }
    Conversion.prototype.getBusinessConversions = function (id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.get("/conversions?business=".concat(id))];
                    case 1:
                        response = _a.sent();
    ...
    Conversion.prototype.fetchConversion = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        request = this.getBaseUrl();
                        return [4 /*yield*/, request.get("/conversions/".concat(id))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                    case 2:
...
var conv = new Conversion('pk_NjI3ZmVmYmU1YTY1ZWM5OWJhOWFmMGJlOjoxMjE2NzA=', 'hzjMvDeY0dmBrDPSxZH5exnmdNc0aUXy');
var getId = conv.fetchConversion('B-YhsUdg86mu9t');
console.log(getId);
