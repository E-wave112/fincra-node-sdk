...
var Wallet = /** @class */ (function (_super) {
    ...
    function Wallet(publicKey, secretKey) {
    ...
    //     }
    // }
    Wallet.prototype.listWallet = function (id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request.get("/wallets/?businessID=".concat(id))];
                    case 1:
                        response = _a.sent();
                        console.log(response.data);
    ...
    Wallet.prototype.getWallet = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        request = this.getBaseUrl();
                        return [4 /*yield*/, request.get("/wallets/".concat(id))];
                    case 1:
                        response = _a.sent();
                        console.log(response.data);
                        return [2 /*return*/, response.data];
